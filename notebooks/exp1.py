...
mlflow.set_tracking_uri("https://dagshub.com/sheenatks/mlops_project.mlflow ")  # URL to track the experiment

# Load the dataset from a CSV file
data = pd.read_csv("C:\\Users\\mashelkar\\Documents\\PyTorch\\water_potability.csv")
...
with mlflow.start_run():
    ...
    mlflow.set_tag("author", "sheenatks")
